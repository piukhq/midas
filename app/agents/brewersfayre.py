...
class BrewersFayre(RoboBrowserMiner):
    point_conversion_rate = Decimal('0.002')

    def login(self, credentials):
        self.open_url('https://www.brewersfayrebonusclub.co.uk/')
    ...
    def scrape_transactions(self):
        self.open_url('https://www.brewersfayrebonusclub.co.uk/group/brewers/your-account')
