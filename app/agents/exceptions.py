...
errors = {
    VALIDATION: {"code": 401, "message": "Validation of the request has failed.", "name": "Failed validation"},
    STATUS_LOGIN_FAILED: {
        "code": 403,
    ...
    CARD_NUMBER_ERROR: {"code": 436, "message": "Invalid card_number", "name": "Card number error"},
    LINK_LIMIT_EXCEEDED: {"code": 437, "message": "You can only Link one card per day.", "name": "Link Limit Exceeded"},
    CARD_NOT_REGISTERED: {"code": 438, "message": "Unknown Card number", "name": "Card not registered or Unknown"},
    GENERAL_ERROR: {"code": 439, "message": "General Error such as incorrect user details", "name": "General Error"},
    ...
    JOIN_IN_PROGRESS: {"code": 441, "message": "Join in progress", "name": "Join in progress"},
    NO_SUCH_RECORD: {
        "code": 444,
    ...
    RESOURCE_LIMIT_REACHED: {
        "code": 503,
        "message": "there are currently too many balance requests running, please wait before " "trying again",
        "name": "Resource limit reached",
    },
    END_SITE_DOWN: {"code": 530, "message": "The scheme end site is currently down.", "name": "End site down"},
    IP_BLOCKED: {"code": 531, "message": "The end site is currently blocking this ip address", "name": "IP blocked"},
    TRIPPED_CAPTCHA: {"code": 532, "message": "The agent has tripped the scheme capture", "name": "Tripped captcha"},
    PASSWORD_EXPIRED: {
        "code": 533,
    ...
    NOT_SENT: {"code": 535, "message": "Message was not sent", "name": "Message was not sent"},
    CONFIGURATION_ERROR: {
        "code": 536,
...
class AgentError(Exception):
    ...
    def __init__(self, name, message=None, response=None):
