...
class TestRetry(unittest.TestCase):
    ...
    def test_balance_long_value_label(self, mock_post):
        b = {"points": Decimal("0"), "value": Decimal("0"), "value_label": "this is far too long..."}
        item = balance(b, 5, 8, "123-12")
    ...
    def test_create_balance_object(self):
        agent_balance = {"points": Decimal(1.1), "value": Decimal(2.2), "value_label": "points", "reward_tier": 5}
