...
class TestErrorHandler(unittest.TestCase):
    ...
    def test_update_pending_join_called_on_failure(self, mock_update_pending, mock_handle_exception, mock_retry_task):
        ...
        mock_retry_task.return_value.task_type = "attempt-join"
        rq_job = Mock()
