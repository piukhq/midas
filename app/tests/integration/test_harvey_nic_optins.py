...
class TestUserTokenStore(unittest.TestCase):
    ...
    def test_HarveyNick_mock_login_fail(self, mock_login, mock_post, mock_put):
        user_info = {"scheme_account_id": 123, "status": "pending"}
    ...
    def test_HarveyNick_mock_login_real(self, mock_login):
        user_info = {"scheme_account_id": 4, "status": "pending"}
        hn = HarveyNichols(retry_count=1, user_info=user_info)
        hn.scheme_id = 1
        credentials = {
            ...
            "consents": [
                {"id": 8, "slug": "email_optin", "value": True, "created_on": "2018-05-11 12:42"},
                {"id": 9, "slug": "push_optin", "value": False, "created_on": "2018-05-11 12:44"},
            ],
        }
        hn._login(credentials)
